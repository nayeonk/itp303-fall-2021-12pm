...
<?php while ( $row = $results->fetch_assoc() ) : ?>
	<tr>
		<td>
			<!-- confirm() method will allow users to choose 'OK' or 'cancel.' If they choose 'OK', confirm() will return TRUE. If they choose 'Cancel', confirm() will return FALSE. -->
			<a onclick="return confirm('Are you sure you want to delete this track?')" href="delete.php?track_id=<?php echo $row['track_id'];?>&track_name=<?php echo $row['track'];?>" class="btn btn-outline-danger delete-btn">
				Delete
			</a>
		</td>
		<td>
