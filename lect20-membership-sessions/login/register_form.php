...
<body>
	...
	<script>
		// JS valiates the user input. It's the first line of defense. User will NOT be able to submit this form if all inputs are not filled. However, JS can be turned off so server-side also needs to validate
