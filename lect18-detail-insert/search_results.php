...
// Previous sql statement only got the track, genre, and media type. We also need a track_id to pass to details page so we altered the SELECT statement to also include track_id
